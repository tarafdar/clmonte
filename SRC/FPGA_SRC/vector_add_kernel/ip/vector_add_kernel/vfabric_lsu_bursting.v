...
parameter ABITS_PER_LMEM_BANK = 0;
  ...
  defparam lsu_read.ISSTRATIXV = ISSTRATIXV;
  defparam lsu_read.USEINPUTFIFO = USEINPUTFIFO;
  defparam lsu_read.MEMORY_LATENCY = MEMORY_LATENCY;
