    ...
    generate
        ...
        begin
            ...
            begin
                ...
                (* altera_attribute = "-name auto_shift_register_recognition OFF" *) reg [DEPTH-1:0] r_valid;
                logic [DEPTH-1:0] r_valid_in;
                (* altera_attribute = "-name auto_shift_register_recognition OFF" *) reg [DEPTH-1:0][DATA_WIDTH-1:0] r_data;
                logic [DEPTH-1:0][DATA_WIDTH-1:0] r_data_in;
                wire [DEPTH-1:0] r_o_stall;
                logic [DEPTH-1:0] r_i_stall;
                (* altera_attribute = "-name auto_shift_register_recognition OFF" *) reg [DEPTH:0] filled;
