...
(
    clk, reset, o_stall, i_valid, i_address, i_writedata, i_stall, o_valid, 
    o_active, //Debugging signal
...
begin
   ...
   begin
      ...
      wm_wide_be[segment_select*SEGMENT_WIDTH_BYTES +: WIDTH_BYTES] = {WIDTH_BYTES{1'b1}};
...
begin
   ...
   begin
      ...
      wm_wide_be = {MWIDTH_BYTES{1'b0}};
      wm_wide_be[0 +: WIDTH_BYTES] = {WIDTH_BYTES{1'b1}};
