...
input clock, resetn, stall_in, valid_in, initeration_valid_in, exitcond_valid_in, pipeline_stall_in;
output stall_out, valid_out, initeration_stall_out, exitcond_stall_out, pipeline_valid_out;
input data_in, initeration_in, exitcond_in;
output data_out;
...
acl_pop pop2(
   ...
   .valid_in(valid_pop1),
   .data_out(data_push),
   .feedback_in(exitcond_in),
   .feedback_valid_in(exitcond_valid_in),
   .feedback_stall_out(exitcond_stall_out)
);
