...
(
   clk, reset, o_stall, i_valid, i_stall, i_writedata, i_nop, o_valid, 
   o_active, //Debugging signal
...
generate
   ...
   begin : fifo_n
      scfifo #(
         ...
         .rdreq( write_accepted && f_avm_byteenable[n*WIDTH_BYTES] ),
...
assign f_avm_byteenable = fw_out_enable ? fw_byteenable :
                       (lw_out_enable ? lw_byteenable : {MWIDTH_BYTES{1'b1}});
