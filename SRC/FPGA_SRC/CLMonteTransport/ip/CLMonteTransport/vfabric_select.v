...
parameter CONFIG_WIDTH = 7;
 ...
 defparam fifo_raw_dataa.DEPTH = FIFO_DEPTH;
 ...
 defparam fifo_controla.DEPTH = FIFO_DEPTH;
 ...
 defparam fifo_raw_datab.DEPTH = FIFO_DEPTH;
 ...
 defparam fifo_controlb.DEPTH = FIFO_DEPTH;
 ...
 acl_fifo fifo_b ( .clock(clock), .resetn(resetn),
 ...
 defparam fifo_sel.DEPTH = FIFO_DEPTH;
