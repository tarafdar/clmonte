/////////////////////////////////////////////////////////////////
// MODULE CLMonteTransport_system
/////////////////////////////////////////////////////////////////
module CLMonteTransport_system
(
   input logic clock,
   ...
   input logic resetn,
   // AVS avs_MCd_cra
   input logic avs_MCd_cra_read,
   input logic avs_MCd_cra_write,
   input logic [3:0] avs_MCd_cra_address,
   input logic [63:0] avs_MCd_cra_writedata,
   input logic [7:0] avs_MCd_cra_byteenable,
   output logic avs_MCd_cra_waitrequest,
   output logic [63:0] avs_MCd_cra_readdata,
   output logic avs_MCd_cra_readdatavalid,
   ...
   genvar i;
   logic kernel_irqs;
   logic gmem0_global_avm_read [5];
   logic gmem0_global_avm_write [5];
   logic [4:0] gmem0_global_avm_burstcount [5];
   logic [31:0] gmem0_global_avm_address [5];
   logic [511:0] gmem0_global_avm_writedata [5];
   logic [63:0] gmem0_global_avm_byteenable [5];
   logic gmem0_global_avm_waitrequest [5];
   logic [511:0] gmem0_global_avm_readdata [5];
   logic gmem0_global_avm_readdatavalid [5];
   logic gmem0_global_avm_writeack [5];

   // INST MCd of MCd_top_wrapper
   MCd_top_wrapper MCd
   (
      .clock(clock),
      .clock2x(clock2x),
      ...
      .cra_irq(kernel_irqs),
      // AVS avs_cra
      .avs_cra_read(avs_MCd_cra_read),
      .avs_cra_write(avs_MCd_cra_write),
      .avs_cra_address(avs_MCd_cra_address),
      .avs_cra_writedata(avs_MCd_cra_writedata),
      .avs_cra_byteenable(avs_MCd_cra_byteenable),
      .avs_cra_waitrequest(avs_MCd_cra_waitrequest),
      .avs_cra_readdata(avs_MCd_cra_readdata),
      .avs_cra_readdatavalid(avs_MCd_cra_readdatavalid),
      ...
      // AVM avm_local_bb1_ld__u1_inst0
      .avm_local_bb1_ld__u1_inst0_read(gmem0_global_avm_read[2]),
      .avm_local_bb1_ld__u1_inst0_write(gmem0_global_avm_write[2]),
      .avm_local_bb1_ld__u1_inst0_burstcount(gmem0_global_avm_burstcount[2]),
      .avm_local_bb1_ld__u1_inst0_address(gmem0_global_avm_address[2]),
      .avm_local_bb1_ld__u1_inst0_writedata(gmem0_global_avm_writedata[2]),
      .avm_local_bb1_ld__u1_inst0_byteenable(gmem0_global_avm_byteenable[2]),
      .avm_local_bb1_ld__u1_inst0_waitrequest(gmem0_global_avm_waitrequest[2]),
      .avm_local_bb1_ld__u1_inst0_readdata(gmem0_global_avm_readdata[2]),
      .avm_local_bb1_ld__u1_inst0_readdatavalid(gmem0_global_avm_readdatavalid[2]),
      .avm_local_bb1_ld__u1_inst0_writeack(gmem0_global_avm_writeack[2]),
      // AVM avm_local_bb2_atomic_call69_i_inst0
      .avm_local_bb2_atomic_call69_i_inst0_read(gmem0_global_avm_read[3]),
      .avm_local_bb2_atomic_call69_i_inst0_write(gmem0_global_avm_write[3]),
      .avm_local_bb2_atomic_call69_i_inst0_burstcount(gmem0_global_avm_burstcount[3]),
      .avm_local_bb2_atomic_call69_i_inst0_address(gmem0_global_avm_address[3]),
      .avm_local_bb2_atomic_call69_i_inst0_writedata(gmem0_global_avm_writedata[3]),
      .avm_local_bb2_atomic_call69_i_inst0_byteenable(gmem0_global_avm_byteenable[3]),
      .avm_local_bb2_atomic_call69_i_inst0_waitrequest(gmem0_global_avm_waitrequest[3]),
      .avm_local_bb2_atomic_call69_i_inst0_readdata(gmem0_global_avm_readdata[3]),
      .avm_local_bb2_atomic_call69_i_inst0_readdatavalid(gmem0_global_avm_readdatavalid[3]),
      .avm_local_bb2_atomic_call69_i_inst0_writeack(gmem0_global_avm_writeack[3]),
      // AVM avm_local_bb3_st_c0_exe4_inst0
      .avm_local_bb3_st_c0_exe4_inst0_read(gmem0_global_avm_read[4]),
      .avm_local_bb3_st_c0_exe4_inst0_write(gmem0_global_avm_write[4]),
      .avm_local_bb3_st_c0_exe4_inst0_burstcount(gmem0_global_avm_burstcount[4]),
      .avm_local_bb3_st_c0_exe4_inst0_address(gmem0_global_avm_address[4]),
      .avm_local_bb3_st_c0_exe4_inst0_writedata(gmem0_global_avm_writedata[4]),
      .avm_local_bb3_st_c0_exe4_inst0_byteenable(gmem0_global_avm_byteenable[4]),
      .avm_local_bb3_st_c0_exe4_inst0_waitrequest(gmem0_global_avm_waitrequest[4]),
      .avm_local_bb3_st_c0_exe4_inst0_readdata(gmem0_global_avm_readdata[4]),
      .avm_local_bb3_st_c0_exe4_inst0_readdatavalid(gmem0_global_avm_readdatavalid[4]),
      .avm_local_bb3_st_c0_exe4_inst0_writeack(gmem0_global_avm_writeack[4])
   );

   assign kernel_irq = |kernel_irqs;
   generate
   begin:gmem0_
      logic gmem0_icm_in_arb_request [5];
      logic gmem0_icm_in_arb_read [5];
      logic gmem0_icm_in_arb_write [5];
      logic [4:0] gmem0_icm_in_arb_burstcount [5];
      logic [25:0] gmem0_icm_in_arb_address [5];
      logic [511:0] gmem0_icm_in_arb_writedata [5];
      logic [63:0] gmem0_icm_in_arb_byteenable [5];
      logic gmem0_icm_in_arb_stall [5];
      logic gmem0_icm_in_wrp_ack [5];
      logic gmem0_icm_in_rrp_datavalid [5];
      logic [511:0] gmem0_icm_in_rrp_data [5];
      ...
      logic [25:0] gmem0_icm_preroute_arb_address [4];
      logic [511:0] gmem0_icm_preroute_arb_writedata [4];
      logic [63:0] gmem0_icm_preroute_arb_byteenable [4];
      logic gmem0_icm_preroute_arb_stall [4];
      logic gmem0_icm_preroute_wrp_ack [4];
      logic gmem0_icm_preroute_rrp_datavalid [4];
      logic [511:0] gmem0_icm_preroute_rrp_data [4];
      logic icm_groupgmem0_router_0_arb_request [2];
      logic icm_groupgmem0_router_0_arb_read [2];
      logic icm_groupgmem0_router_0_arb_write [2];
      logic [4:0] icm_groupgmem0_router_0_arb_burstcount [2];
      logic [25:0] icm_groupgmem0_router_0_arb_address [2];
      logic [511:0] icm_groupgmem0_router_0_arb_writedata [2];
      logic [63:0] icm_groupgmem0_router_0_arb_byteenable [2];
      logic icm_groupgmem0_router_0_arb_stall [2];
      logic icm_groupgmem0_router_0_wrp_ack [2];
      logic icm_groupgmem0_router_0_rrp_datavalid [2];
      logic [511:0] icm_groupgmem0_router_0_rrp_data [2];
      ...
      logic [25:0] icm_groupgmem0_router_3_arb_address [1];
      logic [511:0] icm_groupgmem0_router_3_arb_writedata [1];
      logic [63:0] icm_groupgmem0_router_3_arb_byteenable [1];
      ...
      logic [511:0] icm_groupgmem0_router_3_rrp_data [1];
      ...
      logic [511:0] icm_routedgmem0_port_0_0_rw_arb_writedata [4];
      logic [63:0] icm_routedgmem0_port_0_0_rw_arb_byteenable [4];
      ...
      logic [511:0] icm_routedgmem0_port_0_0_rw_rrp_data [4];
      ...
      logic [30:0] avm_mem_atomics_ingmem0_port_0_0_rw_address;
      logic [511:0] avm_mem_atomics_ingmem0_port_0_0_rw_writedata;
      logic [63:0] avm_mem_atomics_ingmem0_port_0_0_rw_byteenable;
      logic avm_mem_atomics_ingmem0_port_0_0_rw_waitrequest;
      logic [511:0] avm_mem_atomics_ingmem0_port_0_0_rw_readdata;
      logic avm_mem_atomics_ingmem0_port_0_0_rw_readdatavalid;
      logic avm_mem_atomics_ingmem0_port_0_0_rw_writeack;
      logic icm_routedgmem0_port_1_0_rw_arb_request [4];
      logic icm_routedgmem0_port_1_0_rw_arb_read [4];
      logic icm_routedgmem0_port_1_0_rw_arb_write [4];
      logic [4:0] icm_routedgmem0_port_1_0_rw_arb_burstcount [4];
      logic [24:0] icm_routedgmem0_port_1_0_rw_arb_address [4];
      logic [511:0] icm_routedgmem0_port_1_0_rw_arb_writedata [4];
      logic [63:0] icm_routedgmem0_port_1_0_rw_arb_byteenable [4];
      logic icm_routedgmem0_port_1_0_rw_arb_stall [4];
      logic icm_routedgmem0_port_1_0_rw_wrp_ack [4];
      logic icm_routedgmem0_port_1_0_rw_rrp_datavalid [4];
      logic [511:0] icm_routedgmem0_port_1_0_rw_rrp_data [4];
      logic avm_mem_atomics_ingmem0_port_1_0_rw_read;
      logic avm_mem_atomics_ingmem0_port_1_0_rw_write;
      logic [4:0] avm_mem_atomics_ingmem0_port_1_0_rw_burstcount;
      logic [30:0] avm_mem_atomics_ingmem0_port_1_0_rw_address;
      logic [511:0] avm_mem_atomics_ingmem0_port_1_0_rw_writedata;
      logic [63:0] avm_mem_atomics_ingmem0_port_1_0_rw_byteenable;
      logic avm_mem_atomics_ingmem0_port_1_0_rw_waitrequest;
      logic [511:0] avm_mem_atomics_ingmem0_port_1_0_rw_readdata;
      logic avm_mem_atomics_ingmem0_port_1_0_rw_readdatavalid;
      logic avm_mem_atomics_ingmem0_port_1_0_rw_writeack;
      ...
      assign icm_groupgmem0_router_0_arb_request[1] = gmem0_icm_in_arb_request[4];
      assign icm_groupgmem0_router_0_arb_read[1] = gmem0_icm_in_arb_read[4];
      assign icm_groupgmem0_router_0_arb_write[1] = gmem0_icm_in_arb_write[4];
      assign icm_groupgmem0_router_0_arb_burstcount[1] = gmem0_icm_in_arb_burstcount[4];
      assign icm_groupgmem0_router_0_arb_address[1] = gmem0_icm_in_arb_address[4];
      assign icm_groupgmem0_router_0_arb_writedata[1] = gmem0_icm_in_arb_writedata[4];
      assign icm_groupgmem0_router_0_arb_byteenable[1] = gmem0_icm_in_arb_byteenable[4];
      assign gmem0_icm_in_arb_stall[4] = icm_groupgmem0_router_0_arb_stall[1];
      assign gmem0_icm_in_wrp_ack[4] = icm_groupgmem0_router_0_wrp_ack[1];
      assign gmem0_icm_in_rrp_datavalid[4] = icm_groupgmem0_router_0_rrp_datavalid[1];
      assign gmem0_icm_in_rrp_data[4] = icm_groupgmem0_router_0_rrp_data[1];
      ...
      // INST global_ic_preroutegmem0_router_3 of interconnect_1
      interconnect_1 global_ic_preroutegmem0_router_3
      (
         .clock(clock),
         .resetn(resetn),
         // ICM m
      ...
      begin:router
         ...
         assign bank_select[0] = (gmem0_icm_preroute_arb_address[i][25] == 1'b0);
         assign bank_select[1] = (gmem0_icm_preroute_arb_address[i][25] == 1'b1);
      end
      ...
      (
         ...
         // AVM mem_avm
         .mem_avm_read(avm_memgmem0_port_0_0_rw_read),
         .mem_avm_write(avm_memgmem0_port_0_0_rw_write),
         .mem_avm_burstcount(avm_memgmem0_port_0_0_rw_burstcount),
         .mem_avm_address(avm_memgmem0_port_0_0_rw_address),
         .mem_avm_writedata(avm_memgmem0_port_0_0_rw_writedata),
         .mem_avm_byteenable(avm_memgmem0_port_0_0_rw_byteenable),
         .mem_avm_waitrequest(avm_memgmem0_port_0_0_rw_waitrequest),
         .mem_avm_readdata(avm_memgmem0_port_0_0_rw_readdata),
         .mem_avm_readdatavalid(avm_memgmem0_port_0_0_rw_readdatavalid),
         .mem_avm_writeack(avm_memgmem0_port_0_0_rw_writeack)
      );
      ...
      (
         ...
         // AVM avm
         .avm_read(avm_mem_atomics_ingmem0_port_1_0_rw_read),
         .avm_write(avm_mem_atomics_ingmem0_port_1_0_rw_write),
         .avm_burstcount(avm_mem_atomics_ingmem0_port_1_0_rw_burstcount),
         .avm_address(avm_mem_atomics_ingmem0_port_1_0_rw_address),
         .avm_writedata(avm_mem_atomics_ingmem0_port_1_0_rw_writedata),
         .avm_byteenable(avm_mem_atomics_ingmem0_port_1_0_rw_byteenable),
         .avm_waitrequest(avm_mem_atomics_ingmem0_port_1_0_rw_waitrequest),
         .avm_readdata(avm_mem_atomics_ingmem0_port_1_0_rw_readdata),
         .avm_readdatavalid(avm_mem_atomics_ingmem0_port_1_0_rw_readdatavalid),
         .avm_writeack(avm_mem_atomics_ingmem0_port_1_0_rw_writeack)
      );

      // INST acl_atomics_nostallgmem0_port_1_0_rw of acl_atomics_nostall
      acl_atomics_nostall
      #(
         .DATA_WIDTH(512),
         .BURST_WIDTH(5),
      ...
      acl_atomics_nostallgmem0_port_1_0_rw
      (
         .clock(clock),
         .resetn(resetn),
         // AVM mem_arb
         .mem_arb_read(avm_mem_atomics_ingmem0_port_1_0_rw_read),
         .mem_arb_write(avm_mem_atomics_ingmem0_port_1_0_rw_write),
         .mem_arb_burstcount(avm_mem_atomics_ingmem0_port_1_0_rw_burstcount),
         .mem_arb_address(avm_mem_atomics_ingmem0_port_1_0_rw_address),
         .mem_arb_writedata(avm_mem_atomics_ingmem0_port_1_0_rw_writedata),
         .mem_arb_byteenable(avm_mem_atomics_ingmem0_port_1_0_rw_byteenable),
         .mem_arb_waitrequest(avm_mem_atomics_ingmem0_port_1_0_rw_waitrequest),
         .mem_arb_readdata(avm_mem_atomics_ingmem0_port_1_0_rw_readdata),
         .mem_arb_readdatavalid(avm_mem_atomics_ingmem0_port_1_0_rw_readdatavalid),
         .mem_arb_writeack(avm_mem_atomics_ingmem0_port_1_0_rw_writeack),
         // AVM mem_avm
         .mem_avm_read(avm_memgmem0_port_1_0_rw_read),
         .mem_avm_write(avm_memgmem0_port_1_0_rw_write),
         .mem_avm_burstcount(avm_memgmem0_port_1_0_rw_burstcount),
         .mem_avm_address(avm_memgmem0_port_1_0_rw_address),
         .mem_avm_writedata(avm_memgmem0_port_1_0_rw_writedata),
         .mem_avm_byteenable(avm_memgmem0_port_1_0_rw_byteenable),
         .mem_avm_waitrequest(avm_memgmem0_port_1_0_rw_waitrequest),
         .mem_avm_readdata(avm_memgmem0_port_1_0_rw_readdata),
         .mem_avm_readdatavalid(avm_memgmem0_port_1_0_rw_readdatavalid),
         .mem_avm_writeack(avm_memgmem0_port_1_0_rw_writeack)
      );
...
(
   ...
   // AVM avm_local_bb1_ld__u1_inst0
   output logic avm_local_bb1_ld__u1_inst0_read,
   output logic avm_local_bb1_ld__u1_inst0_write,
   output logic [4:0] avm_local_bb1_ld__u1_inst0_burstcount,
   output logic [31:0] avm_local_bb1_ld__u1_inst0_address,
   output logic [511:0] avm_local_bb1_ld__u1_inst0_writedata,
   output logic [63:0] avm_local_bb1_ld__u1_inst0_byteenable,
   input logic avm_local_bb1_ld__u1_inst0_waitrequest,
   input logic [511:0] avm_local_bb1_ld__u1_inst0_readdata,
   input logic avm_local_bb1_ld__u1_inst0_readdatavalid,
   input logic avm_local_bb1_ld__u1_inst0_writeack,
   // AVM avm_local_bb2_atomic_call69_i_inst0
   output logic avm_local_bb2_atomic_call69_i_inst0_read,
   output logic avm_local_bb2_atomic_call69_i_inst0_write,
   output logic [4:0] avm_local_bb2_atomic_call69_i_inst0_burstcount,
   output logic [31:0] avm_local_bb2_atomic_call69_i_inst0_address,
   output logic [511:0] avm_local_bb2_atomic_call69_i_inst0_writedata,
   output logic [63:0] avm_local_bb2_atomic_call69_i_inst0_byteenable,
   input logic avm_local_bb2_atomic_call69_i_inst0_waitrequest,
   input logic [511:0] avm_local_bb2_atomic_call69_i_inst0_readdata,
   input logic avm_local_bb2_atomic_call69_i_inst0_readdatavalid,
   input logic avm_local_bb2_atomic_call69_i_inst0_writeack,
   // AVM avm_local_bb3_st_c0_exe4_inst0
   output logic avm_local_bb3_st_c0_exe4_inst0_read,
   output logic avm_local_bb3_st_c0_exe4_inst0_write,
   output logic [4:0] avm_local_bb3_st_c0_exe4_inst0_burstcount,
   output logic [31:0] avm_local_bb3_st_c0_exe4_inst0_address,
   output logic [511:0] avm_local_bb3_st_c0_exe4_inst0_writedata,
   output logic [63:0] avm_local_bb3_st_c0_exe4_inst0_byteenable,
   input logic avm_local_bb3_st_c0_exe4_inst0_waitrequest,
   input logic [511:0] avm_local_bb3_st_c0_exe4_inst0_readdata,
   input logic avm_local_bb3_st_c0_exe4_inst0_readdatavalid,
   input logic avm_local_bb3_st_c0_exe4_inst0_writeack
);
   logic lmem_invalid_single_bit;

   // INST kernel of MCd_function_wrapper
   MCd_function_wrapper kernel
   (
      ...
      // AVM avm_local_bb1_ld__u1_inst0
      .avm_local_bb1_ld__u1_inst0_read(avm_local_bb1_ld__u1_inst0_read),
      .avm_local_bb1_ld__u1_inst0_write(avm_local_bb1_ld__u1_inst0_write),
      .avm_local_bb1_ld__u1_inst0_burstcount(avm_local_bb1_ld__u1_inst0_burstcount),
      .avm_local_bb1_ld__u1_inst0_address(avm_local_bb1_ld__u1_inst0_address),
      .avm_local_bb1_ld__u1_inst0_writedata(avm_local_bb1_ld__u1_inst0_writedata),
      .avm_local_bb1_ld__u1_inst0_byteenable(avm_local_bb1_ld__u1_inst0_byteenable),
      .avm_local_bb1_ld__u1_inst0_waitrequest(avm_local_bb1_ld__u1_inst0_waitrequest),
      .avm_local_bb1_ld__u1_inst0_readdata(avm_local_bb1_ld__u1_inst0_readdata),
      .avm_local_bb1_ld__u1_inst0_readdatavalid(avm_local_bb1_ld__u1_inst0_readdatavalid),
      .avm_local_bb1_ld__u1_inst0_writeack(avm_local_bb1_ld__u1_inst0_writeack),
      // AVM avm_local_bb2_atomic_call69_i_inst0
      .avm_local_bb2_atomic_call69_i_inst0_read(avm_local_bb2_atomic_call69_i_inst0_read),
      .avm_local_bb2_atomic_call69_i_inst0_write(avm_local_bb2_atomic_call69_i_inst0_write),
      .avm_local_bb2_atomic_call69_i_inst0_burstcount(avm_local_bb2_atomic_call69_i_inst0_burstcount),
      .avm_local_bb2_atomic_call69_i_inst0_address(avm_local_bb2_atomic_call69_i_inst0_address),
      .avm_local_bb2_atomic_call69_i_inst0_writedata(avm_local_bb2_atomic_call69_i_inst0_writedata),
      .avm_local_bb2_atomic_call69_i_inst0_byteenable(avm_local_bb2_atomic_call69_i_inst0_byteenable),
      .avm_local_bb2_atomic_call69_i_inst0_waitrequest(avm_local_bb2_atomic_call69_i_inst0_waitrequest),
      .avm_local_bb2_atomic_call69_i_inst0_readdata(avm_local_bb2_atomic_call69_i_inst0_readdata),
      .avm_local_bb2_atomic_call69_i_inst0_readdatavalid(avm_local_bb2_atomic_call69_i_inst0_readdatavalid),
      .avm_local_bb2_atomic_call69_i_inst0_writeack(avm_local_bb2_atomic_call69_i_inst0_writeack),
      // AVM avm_local_bb3_st_c0_exe4_inst0
      .avm_local_bb3_st_c0_exe4_inst0_read(avm_local_bb3_st_c0_exe4_inst0_read),
      .avm_local_bb3_st_c0_exe4_inst0_write(avm_local_bb3_st_c0_exe4_inst0_write),
      .avm_local_bb3_st_c0_exe4_inst0_burstcount(avm_local_bb3_st_c0_exe4_inst0_burstcount),
      .avm_local_bb3_st_c0_exe4_inst0_address(avm_local_bb3_st_c0_exe4_inst0_address),
      .avm_local_bb3_st_c0_exe4_inst0_writedata(avm_local_bb3_st_c0_exe4_inst0_writedata),
      .avm_local_bb3_st_c0_exe4_inst0_byteenable(avm_local_bb3_st_c0_exe4_inst0_byteenable),
      .avm_local_bb3_st_c0_exe4_inst0_waitrequest(avm_local_bb3_st_c0_exe4_inst0_waitrequest),
      .avm_local_bb3_st_c0_exe4_inst0_readdata(avm_local_bb3_st_c0_exe4_inst0_readdata),
      .avm_local_bb3_st_c0_exe4_inst0_readdatavalid(avm_local_bb3_st_c0_exe4_inst0_readdatavalid),
      .avm_local_bb3_st_c0_exe4_inst0_writeack(avm_local_bb3_st_c0_exe4_inst0_writeack)
   );
