...
__kernel void Reflect_test1(__global float* dir_array, __global float* pos_array, __global unsigned int* xd, __global unsigned int* cd, __global unsigned int* ad, __global unsigned int* histd, __global unsigned int* retval) {
