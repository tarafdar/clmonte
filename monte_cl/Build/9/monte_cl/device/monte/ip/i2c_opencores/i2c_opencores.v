...
assign scl_pad_io = scl_padoen_od ? 1'bZ : scl_pad_od;
...
assign sda_pad_io = sda_padoen_od ? 1'bZ : sda_pad_od;
...
always @(posedge wb_clk_i)
      begin
      sda_pad_id    <= sda_pad_i;
      scl_pad_id    <= scl_pad_i;
      sda_pad_od    <= sda_pad_o;
      scl_pad_od    <= scl_pad_o;
      sda_padoen_od <= sda_padoen_o;
      scl_padoen_od <= scl_padoen_o;
      end
...
(
	...
	.scl_pad_i(scl_pad_id), .scl_pad_o(scl_pad_o), .scl_padoen_o(scl_padoen_o),
	.sda_pad_i(sda_pad_id), .sda_pad_o(sda_pad_o), .sda_padoen_o(sda_padoen_o)
);
