...
module altera_avalon_st_clock_crosser(
  ...
  parameter  FORWARD_SYNC_DEPTH  = 2;     // Hard encoded below.
  parameter  BACKWARD_SYNC_DEPTH = 2;     // Hard encoded below.
  ...
  altera_std_synchronizer #(.depth(6)) in_to_out_synchronizer (
				     .clk(out_clk),
				     .reset_n(~out_reset),
				     .din(in_data_toggle),
  ...
  altera_std_synchronizer #(.depth(2)) out_to_in_synchronizer (
				     .clk(in_clk),
				     .reset_n(~in_reset),
