                                 ...
                                 __global UINT32CL *tstates_is_active  )
{
  ...
  for (int iIndex = 0; iIndex < 32768; ++iIndex)
  {
    ...
    if (is_active)
    {
      ...
      cosdn[0] = dot_product(pkt.d.x, pkt.d.y, pkt.d.z, tetra.face[0][0], tetra.face[0][1], tetra.face[0][2]); // = |d|cos0
      ...
      dis[0] = dot_product(pkt.p.x,pkt.p.y,pkt.p.z,tetra.face[0][0],tetra.face[0][1],tetra.face[0][2])-tetra.face[0][3]; // (p*n) - d = |p-p0|cos0
