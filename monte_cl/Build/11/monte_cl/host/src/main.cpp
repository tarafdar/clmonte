...
int RunGPUi(HostThreadState *hstate, Tetra *tetra_mesh, Material *materialspec, Source *p_src)
{
  ...
  // User-visible output - Platform information
  {
	...
	DevDataSeg dev_dseg;
	init_device_data_seg(context, command_queue, *HostMem->n_photons_left, &source, tetra_mesh, materialspec, HostMem->absorption, HostMem->transmittance, &dev_dseg, num_tetras, num_mats, launcher_rng_init, stepper_rng_init, dropper_rng_init, spinner_rng_init, reflactor_rng_init);
                            ...
                            TriNode *trinodes, TetraNode *tetranodes, Source *p_src)
{
  ...
  // Launch simulation
  RunGPUi (hstates, tetra_mesh, materialspec, p_src);
